...
namespace DVLD.Tests
{
    public partial class frmListTestAppointments: Form
    {
        ...
        private void btnAddNewAppointment_Click(object sender, EventArgs e)
        {
            ...
            // if the person had never attend the Test
            if (LastTest == null)
            {
            ...
            //if person already passed the test
            if (LastTest.TestResult == true)
            {
                MessageBox.Show("This person has already passed this test before", "Not Allowed", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }

            //if the person attends the Test but didn't pass it then he can retake the Test
