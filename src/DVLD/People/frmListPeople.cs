...
namespace DVLD.People
{
    public partial class frmListPeople : Form
    {
      ...
      private DataTable _dtPeople = _dtAllPeople.DefaultView.ToTable(false, "PersonID", "CIN","FirstName",
                                                                    "LastName","GendorCaption", "DateOfBirth",
        ...
        private void _RefreshPeopleList()
        {
            ...
            _dtPeople = _dtAllPeople.DefaultView.ToTable(false, "PersonID", "CIN", "FirstName", "LastName",
        ...
        private void frmListPeople_Load(object sender, EventArgs e)
        {
            ...
            if (dgvPeople.Rows.Count > 0)
            {
                ...
                dgvPeople.Columns[1].HeaderText = "CIN";
